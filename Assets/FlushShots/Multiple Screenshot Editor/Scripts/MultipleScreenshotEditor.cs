...
namespace MultipleScreenshot.Editor
{
    ...
    public class MultipleScreenshotEditor : EditorWindow
    {
        ...
        private bool timeSetZero = false;

        [MenuItem("Window/FlushShots/Multiple Screenshot Editor #t")]
      ...
      {/*
          ...
          */
          TextAsset json_yazi = new TextAsset(File.ReadAllText(Application.dataPath +"/FlushShots/Multiple Screenshot Editor/Json_Device_Currently_Save_List.json"));
          _Root = JsonUtility.FromJson<DeviceList>(json_yazi.text);
          
          ScriptableObject target = this;
          _soData = new SerializedObject(target);
          
          TextAsset json_setting = new TextAsset(File.ReadAllText(Application.dataPath +"/FlushShots/Multiple Screenshot Editor/Json_Setting.json"));
      ...
      void OnDisable()
        {
            ...
            File.WriteAllText(Application.dataPath +"/FlushShots/Multiple Screenshot Editor/Json_Device_Currently_Save_List.json",Json_added);
            ///// 
            string Json_setting = JsonUtility.ToJson(_saveSetting);
            File.WriteAllText(Application.dataPath +"/FlushShots/Multiple Screenshot Editor/Json_Setting.json",Json_setting);
        }
/*
      ...
      private static void CompilationPipelineOnAssemblyCompilationFinished(string f, CompilerMessage[] compilerMessages)
      {
        ...
        private void OnGUI()
        {
            ...
            if (GUILayout.Button ("Load Json",GUILayout.Height(50),GUILayout.MinWidth(160)))
            {
                ...
                TextAsset json_yazi = new TextAsset(File.ReadAllText(Application.dataPath +"/FlushShots/Multiple Screenshot Editor/Json_Device_Save_List.json"));
                _Root = JsonUtility.FromJson<DeviceList>(json_yazi.text);
            ...
            {
                string Json_added = JsonUtility.ToJson(_Root);
                File.WriteAllText(Application.dataPath +"/FlushShots/Multiple Screenshot Editor/Json_Device_Save_List.json",Json_added);
            }
            ...
            EditorGUILayout.LabelField("'T' Tuşu ile zamanı durdur", EditorStyles.helpBox,GUILayout.Height(30));
            EditorGUILayout.LabelField("'Space' ile Screenshot Al", EditorStyles.helpBox,GUILayout.Height(30));
    ...
    public class PopUp : EditorWindow
    {
        ...
        // [MenuItem("Window/FlushShots/Give Rate Pop-up")]
        ...
        void OnGUI()
        {
            ...
            Texture banner = (Texture)AssetDatabase.LoadAssetAtPath("Assets/FlushShots/Multiple Screenshot Editor/Logo/ss_icon.png", typeof(Texture));
